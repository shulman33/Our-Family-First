export default function Testimonial() {
  return (
    <section className="isolate overflow-hidden bg-sectionBlue px-6 lg:px-8">
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <svg
              ...
              viewBox="0 0 162 128"
              aria-hidden="true"
              className="absolute -top-12 left-0 -z-10 h-32 stroke-gray-950/20"
            >
              <path
            ...
            <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
              <p>
                ...
                saved their marriages, given them tools they truly needed and
                had made them a stronger couple than ever before. You saved
                families
              </p>
            </blockquote>
          </div>
          <figcaption className="text-center text-base lg:col-start-1 lg:row-start-3">
