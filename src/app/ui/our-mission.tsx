                ...
                <div className="lg:w-1/2">
                    <div className="mx-auto max-w-2xl lg:mx-0 text-center lg:text-left"> 
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 lg:text-justify">
                            ...
                            for mental health support to assist Chayalim and Chayalot as
                            they return to their families from the frontlines. We provide
                            psycho-educational workshops and couples counseling during
                            overnight retreats. Our mission is to address mental health,
                            marital and parenting issues with members of the military as
                            they reintegrate into their families after experiencing life
                            altering trauma during the war. We strive to help each person
                            achieve a sense of security and stability in their families so
                            that they can return to combat with the clear mind that is
                            necessary to protect the members of their military family.
                        </p>
                    </div>
                </div>
            </div>
